...
out.fn <- "/n/holystore01/LABS/xlin/Lab/zhouhufeng/Data/CCDGF2/GDS/temp/AGDSv8/ccdgf2_qced_chr16.gds"
...
batchAnnotate <- function(inputData)	{
		...
		connection <- dbConnect(driver, dbname='performChr16', host='holy7c04209', port=8687, user='zhouhufeng', password='secretepwd')
