...
out.fn <- "/n/holystore01/LABS/xlin/Lab/zhouhufeng/Data/CCDGF2/GDS/temp/AGDSv8/ccdgf2_qced_chr3.gds"
...
batchAnnotate <- function(inputData)	{
		...
		connection <- dbConnect(driver, dbname='performChr3', host='holy7c06612', port=7133, user='zhouhufeng', password='secretepwd')
...
#Anno.folder <- index.gdsn(genofile, "annotation/info/Sept9th21")
