...
out.fn <- "/n/holystore01/LABS/xlin/Lab/zhouhufeng/Data/CCDGF2/GDS/temp/AGDSv8/ccdgf2_qced_chr2.gds"
#out.fn <- "/n/holystore01/LABS/xlin/Lab/zhouhufeng/Data/Annotator/Data/XinAnData/aGDSv3/hg38chr2.agds"
...
batchAnnotate <- function(inputData)	{
		...
		connection <- dbConnect(driver, dbname='performChr2', host='holy7c10309', port=9522, user='zhouhufeng', password='secretepwd')
