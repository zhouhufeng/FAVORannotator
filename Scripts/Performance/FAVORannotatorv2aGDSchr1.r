...
#out.fn <- "/n/holystore01/LABS/xlin/Lab/zhouhufeng/Data/Annotator/Data/XinAnData/aGDSv3/hg38chr1.agds"
out.fn <- "/n/holystore01/LABS/xlin/Lab/zhouhufeng/Data/CCDGF2/GDS/temp/AGDSv8/ccdgf2_qced_chr1.gds"
...
batchAnnotate <- function(inputData)	{
		...
		connection <- dbConnect(driver, dbname='performChr1', host='holy7c16303', port=10046, user='zhouhufeng', password='secretepwd')
