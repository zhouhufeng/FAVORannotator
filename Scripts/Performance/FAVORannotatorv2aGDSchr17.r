...
out.fn <- "/n/holystore01/LABS/xlin/Lab/zhouhufeng/Data/CCDGF2/GDS/temp/AGDSv8/ccdgf2_qced_chr17.gds"
...
batchAnnotate <- function(inputData)	{
		...
		connection <- dbConnect(driver, dbname='performChr17', host='holy7c04106', port=9247, user='zhouhufeng', password='secretepwd')
